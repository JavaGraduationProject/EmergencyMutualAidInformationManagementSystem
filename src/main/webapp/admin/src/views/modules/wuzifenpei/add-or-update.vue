  ...
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="分配编号" prop="fenpeibianhao">
          <el-input v-model="ruleForm.fenpeibianhao" 
              placeholder="分配编号" clearable  :readonly="ro.fenpeibianhao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="分配编号" prop="fenpeibianhao">
              <el-input v-model="ruleForm.fenpeibianhao" 
      ...
      <el-col :span="12">
        ...
        <div v-else>
          <el-form-item class="input" label="物资种类" prop="wuzizhonglei">
              <el-input v-model="ruleForm.wuzizhonglei" 
                placeholder="物资种类" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        <el-form-item class="date" v-if="type!='info'" label="分配日期" prop="fenpeiriqi">
            <el-date-picker
        ...
        <div v-else>
          <el-form-item class="input" v-if="ruleForm.fenpeiriqi" label="分配日期" prop="fenpeiriqi">
              <el-input v-model="ruleForm.fenpeiriqi" 
                placeholder="分配日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="分配原因" prop="fenpeiyuanyin">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="分配原因"
                  v-model="ruleForm.fenpeiyuanyin" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.fenpeiyuanyin" label="分配原因" prop="fenpeiyuanyin">
                    <span>{{ruleForm.fenpeiyuanyin}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
  ...
  data() {
	...
	xingming : false,
      ...
      rules: {
          ...
          wuzizhonglei: [
                { required: true, message: '物资种类不能为空', trigger: 'blur' },
          ],
          shuliang: [
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.fenpeiriqi = true;
          ...
          if(o=='fenpeiyuanyin'){
            this.ruleForm.fenpeiyuanyin = obj[o];
	    this.ro.fenpeiyuanyin = true;
            continue;
          }
          if(o=='zhanghao'){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `wuzifenpei/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.wuzifenpeiCrossAddOrUpdateFlag = false;
						 this.parent.search();
