    ...
    >
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="报名原因" prop="baomingyuanyin">
                <editor 
                    style="min-width: 200px; max-width: 600px;"
                    v-model="ruleForm.baomingyuanyin" 
                    class="editor" 
                    action="file/upload">
                </editor>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.baomingyuanyin" label="报名原因" prop="baomingyuanyin">
                    <span v-html="ruleForm.baomingyuanyin"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.baomingyuanyin = this.ruleForm.baomingyuanyin.replace(reg,'../../../ssmb06jd/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
