<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="工作状态" prop="gongzuozhuangtai">
        ...
        <div v-else>
          <el-form-item class="input" label="工作状态" prop="gongzuozhuangtai">
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="志愿账号" prop="zhiyuanzhanghao">
          <el-input v-model="ruleForm.zhiyuanzhanghao" 
              placeholder="志愿账号" clearable  :readonly="ro.zhiyuanzhanghao"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="志愿账号" prop="zhiyuanzhanghao">
              <el-input v-model="ruleForm.zhiyuanzhanghao" 
                placeholder="志愿账号" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="志愿姓名" prop="zhiyuanxingming">
          <el-input v-model="ruleForm.zhiyuanxingming" 
              placeholder="志愿姓名" clearable  :readonly="ro.zhiyuanxingming"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="志愿姓名" prop="zhiyuanxingming">
              <el-input v-model="ruleForm.zhiyuanxingming" 
                placeholder="志愿姓名" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      </el-row>
          <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="内容描述" prop="neirongmiaoshu">
                <el-input
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.neirongmiaoshu" label="内容描述" prop="neirongmiaoshu">
                    <span>{{ruleForm.neirongmiaoshu}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.zhiyuanzhanghao = true;
          ...
          if(o=='zhiyuanxingming'){
            this.ruleForm.zhiyuanxingming = obj[o];
	    this.ro.zhiyuanxingming = true;
            continue;
          }
        }
      }
      ...
      this.$http({
        ...
        if (data && data.code === 0) {
          var json = data.data;
		if(json.zhiyuanzhanghao!=''&&json.zhiyuanzhanghao){
                this.ruleForm.zhiyuanzhanghao = json.zhiyuanzhanghao
	    		this.ro.zhiyuanzhanghao = true;
		}
		if(json.zhiyuanxingming!=''&&json.zhiyuanxingming){
                this.ruleForm.zhiyuanxingming = json.zhiyuanxingming
	    		this.ro.zhiyuanxingming = true;
		}
        } else {
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `gongzuotijiao/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.gongzuotijiaoCrossAddOrUpdateFlag = false;
						 this.parent.search();
