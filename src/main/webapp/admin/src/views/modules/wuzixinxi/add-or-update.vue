<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="物资种类" prop="wuzizhonglei">
          <el-select :disabled="ro.wuzizhonglei" v-model="ruleForm.wuzizhonglei" placeholder="请选择物资种类">
            <el-option
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="物资详情" prop="wuzixiangqing">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.wuzixiangqing" label="物资详情" prop="wuzixiangqing">
                    <span v-html="ruleForm.wuzixiangqing"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
	...
	this.ruleForm.wuzixiangqing = this.ruleForm.wuzixiangqing.replace(reg,'../../../ssmb06jd/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `wuzixinxi/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.wuzixinxiCrossAddOrUpdateFlag = false;
						 this.parent.search();
