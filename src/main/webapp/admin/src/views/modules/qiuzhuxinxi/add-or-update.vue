<template>
  <div class="addEdit-block">
    ...
    >
      ...
      <el-col :span="12">
        <el-form-item class="select" v-if="type!='info'"  label="求助类型" prop="qiuzhuleixing">
          <el-select :disabled="ro.qiuzhuleixing" v-model="ruleForm.qiuzhuleixing" placeholder="请选择求助类型">
            <el-option
        ...
        <div v-else>
          <el-form-item class="input" label="求助类型" prop="qiuzhuleixing">
	      <el-input v-model="ruleForm.qiuzhuleixing"
      ...
      <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="具体地址" prop="jutidizhi">
          <el-input v-model="ruleForm.jutidizhi" 
              placeholder="具体地址" clearable  :readonly="ro.jutidizhi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="具体地址" prop="jutidizhi">
              <el-input v-model="ruleForm.jutidizhi" 
                placeholder="具体地址" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
      <el-col :span="12">
      ...
      <el-col :span="12">
        ...
        <div v-else>
          ...
          <el-row>
            <el-col :span="24">
              <el-form-item v-if="type!='info'"  label="求助内容" prop="qiuzhuneirong">
                <editor 
              ...
              <div v-else>
                <el-form-item v-if="ruleForm.qiuzhuneirong" label="求助内容" prop="qiuzhuneirong">
                    <span v-html="ruleForm.qiuzhuneirong"></span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
...
export default {
  ...
  methods: {
    ...
    init(id,type) {
      ...
      if(this.type=='info'||this.type=='else'){
	    ...
	    this.ro.biaotimingcheng = true;
          ...
          if(o=='qiuzhuleixing'){
            this.ruleForm.qiuzhuleixing = obj[o];
	    this.ro.qiuzhuleixing = true;
            continue;
          }
          if(o=='fengmian'){
	...
	this.ruleForm.qiuzhuneirong = this.ruleForm.qiuzhuneirong.replace(reg,'../../../ssmb06jd/upload');
        } else {
          this.$message.error(data.msg);
        }
      });
