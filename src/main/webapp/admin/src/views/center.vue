  ...
  <div>
    ...
    >  
     <el-row>
      ...
      <el-col :span="12">
        <el-form-item   v-if="flag=='zhiyuanzhe'"  label="志愿账号" prop="zhiyuanzhanghao">
          <el-input v-model="ruleForm.zhiyuanzhanghao" readonly              placeholder="志愿账号" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
        <el-form-item   v-if="flag=='zhiyuanzhe'"  label="志愿姓名" prop="zhiyuanxingming">
          <el-input v-model="ruleForm.zhiyuanxingming"               placeholder="志愿姓名" clearable></el-input>
        </el-form-item>
      </el-col>
      <el-col :span="12">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      ...
      if((!this.ruleForm.zhiyuanzhanghao)&& 'zhiyuanzhe'==this.flag){
      ...
      if((!this.ruleForm.zhiyuanxingming)&& 'zhiyuanzhe'==this.flag){
