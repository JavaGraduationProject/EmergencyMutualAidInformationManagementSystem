      ...
      <div class="login-form">
		...
		<el-form ref="rgsForm" class="rgs-form" :model="rgsForm">
			...
			<!-- <div v-if="tableName=='zhiyuanzhe'" class="input-group">
			   <div class="label">志愿账号</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhiyuanzhanghao" class="input" type="text" placeholder="志愿账号">
			   </div>
			 </div> -->
			<el-form-item label="志愿账号" class="input" v-if="tableName=='zhiyuanzhe'">
			  <el-input v-model="ruleForm.zhiyuanzhanghao" autocomplete="off" placeholder="志愿账号"  />
			</el-form-item>
			<!-- <div v-if="tableName=='zhiyuanzhe'" class="input-group">
			   <div class="label">密码</div>
			   <div class="input-container">
			...
			<!-- <div v-if="tableName=='zhiyuanzhe'" class="input-group">
			   <div class="label">志愿姓名</div>
			   <div class="input-container">
			     <input v-model="ruleForm.zhiyuanxingming" class="input" type="text" placeholder="志愿姓名">
			   </div>
			 </div> -->
			<el-form-item label="志愿姓名" class="input" v-if="tableName=='zhiyuanzhe'">
			  <el-input v-model="ruleForm.zhiyuanxingming" autocomplete="off" placeholder="志愿姓名"  />
			</el-form-item>
			<!-- <div v-if="tableName=='zhiyuanzhe'" class="input-group">
			   <div class="label">年龄</div>
			   <div class="input-container">
...
export default {
  ...
  methods: {
	...
	var url=this.tableName+"/register";
      ...
      if((!this.ruleForm.zhiyuanxingming) && `zhiyuanzhe` == this.tableName){
        this.$message.error(`志愿姓名不能为空`);
        return
      }
