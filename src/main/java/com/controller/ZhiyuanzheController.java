...
public class ZhiyuanzheController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		ZhiyuanzheEntity user = zhiyuanzheService.selectOne(new EntityWrapper<ZhiyuanzheEntity>().eq("zhiyuanzhanghao", username));
    ...
    public R register(@RequestBody ZhiyuanzheEntity zhiyuanzhe){
    	...
    	ZhiyuanzheEntity user = zhiyuanzheService.selectOne(new EntityWrapper<ZhiyuanzheEntity>().eq("zhiyuanzhanghao", zhiyuanzhe.getZhiyuanzhanghao()));
		if(user!=null) {
